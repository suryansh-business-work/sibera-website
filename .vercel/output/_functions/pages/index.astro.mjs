...
const $$HomeBanner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="home-banner" data-astro-cid-hmhpxkkc> <!-- Animated Gradient Background --> <div class="gradient-bg" data-astro-cid-hmhpxkkc></div> <div class="gradient-orb gradient-orb-1" data-astro-cid-hmhpxkkc></div> <div class="gradient-orb gradient-orb-2" data-astro-cid-hmhpxkkc></div> <div class="gradient-orb gradient-orb-3" data-astro-cid-hmhpxkkc></div> <div class="banner-container" data-astro-cid-hmhpxkkc> <!-- Hero Content --> <div class="hero-content" data-astro-cid-hmhpxkkc> <h1 class="hero-title" data-astro-cid-hmhpxkkc>
The <span class="highlight" data-astro-cid-hmhpxkkc>Ultimate</span> Business Management Solution
</h1> <ul class="features-list" data-astro-cid-hmhpxkkc> <li data-astro-cid-hmhpxkkc> <i class="fa-solid fa-circle-check" data-astro-cid-hmhpxkkc></i> <span data-astro-cid-hmhpxkkc><strong data-astro-cid-hmhpxkkc>All-in-one platform.</strong> Support, Tasks, Files, Invoices,
            Time Tracking, and IoT.</span> </li> <li data-astro-cid-hmhpxkkc> <i class="fa-solid fa-server" data-astro-cid-hmhpxkkc></i> <span data-astro-cid-hmhpxkkc><strong data-astro-cid-hmhpxkkc>Seamless Integration.</strong> Connect all your business operations
            in one place.</span> </li> <li data-astro-cid-hmhpxkkc> <i class="fa-solid fa-chart-line" data-astro-cid-hmhpxkkc></i> <span data-astro-cid-hmhpxkkc>Real-time analytics and reporting for better decision making.</span> </li> </ul> <div class="cta-section" data-astro-cid-hmhpxkkc> <span class="cta-label" data-astro-cid-hmhpxkkc>I want to:</span> <div class="cta-buttons" data-astro-cid-hmhpxkkc> <a href="http://localhost:5173/signup" class="cta-btn cta-primary" data-astro-cid-hmhpxkkc> <i class="fa-solid fa-rocket" data-astro-cid-hmhpxkkc></i>
Get Started
</a> <a href="/contact" class="cta-btn cta-secondary" data-astro-cid-hmhpxkkc> <i class="fa-solid fa-envelope" data-astro-cid-hmhpxkkc></i>
Contact Sales
</a> </div> </div> </div> <!-- Dashboard Preview - Full Screen --> <div class="dashboard-preview" data-astro-cid-hmhpxkkc> <div class="dashboard-wrapper" data-astro-cid-hmhpxkkc> <img src="https://ik.imagekit.io/esdata1/sibera/pages-screenshot/all-applications.png" alt="Sibera Dashboard - All Applications Overview" class="dashboard-image" data-astro-cid-hmhpxkkc> <div class="dashboard-glow" data-astro-cid-hmhpxkkc></div> </div> </div> </div> </section> `;
...
</p> </div> </div> </div> </section> <section class="bg-[#f6fafd] py-16 flex flex-col items-center justify-center"> <h2 class="text-3xl md:text-6xl font-bold text-center mb-20" style="font-family: 'Inter', 'Segoe UI', 'Helvetica Neue', Arial, 'sans-serif'; color: #22223b;">
...
Access all your business tools from a single, intuitive dashboard.
						No more switching between multiple apps to get work done.
...
Built to grow with your business. Whether you're a startup or an
						enterprise, Sibera scales to meet your needs.
...
Enterprise-grade security ensures your data is safe. Reliable uptime
						keeps your business running smoothly 24/7.
...
Essential tools for daily operations including invoicing, file
						management, and time tracking.
</p> </div> <!-- Team Collaboration --> <div class="bg-white rounded-2xl shadow p-8 flex flex-col items-center text-center hover:shadow-lg transition"> <i class="fa-solid fa-users text-4xl text-blue-500 mb-4"></i> <h3 class="text-xl font-semibold text-[#151c28] mb-2">
Team Collaboration
</h3> <p class="text-gray-600">
Enhance teamwork with shared tasks, files, and real-time updates.
</p> </div> <!-- Customer Support --> <div class="bg-white rounded-2xl shadow p-8 flex flex-col items-center text-center hover:shadow-lg transition"> <i class="fa-solid fa-headset text-4xl text-blue-500 mb-4"></i> <h3 class="text-xl font-semibold text-[#151c28] mb-2">
Customer Support
</h3> <p class="text-gray-600">
